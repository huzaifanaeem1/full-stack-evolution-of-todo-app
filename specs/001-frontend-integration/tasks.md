...
**Input**: Design documents from `/specs/001-frontend-integration/`
...
- [ ] T203 [P] Update existing frontend pages to use new API client
...
- [ ] T208 Update existing backend endpoints to verify user ownership
...
**Goal**: Enable users to securely access the todo application by visiting login page, entering credentials, and gaining access to their personal task dashboard
...
- [ ] T209 [P] [US1] Contract test for authentication endpoints in backend/tests/test_auth.py
- [ ] T210 [P] [US1] Integration test for user registration flow in backend/tests/test_auth.py
...
- [ ] T220 [P] [US2] Contract test for task endpoints in backend/tests/test_tasks.py
- [ ] T221 [P] [US2] Integration test for task management flow in backend/tests/test_tasks.py
...
- [ ] T228 [P] [US3] Contract test for access control in backend/tests/test_auth.py
- [ ] T229 [P] [US3] Integration test for multi-user isolation in backend/tests/test_tasks.py
